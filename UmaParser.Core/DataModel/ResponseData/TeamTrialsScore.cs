namespace UmaBlobber.DataModel.ResponseData
{
    ...
    public class TeamTrialsScore
    {
        ...
        /// <summary>
        /// Calculated score without ace bonus (if present) but including other bonuses.
        /// </summary>
        public int NonAceScore
        {
            get
            {
                return Score - BonusArray.Where(bonus => bonus.ScoreBonusId == ScoreBonusType.Ace).Sum(bonus => bonus.BonusScore);
            }
        }
    }
}
